...
title: Todo App - Vanilla JavaScript Task Manager with Drag and Drop

description: Browser-based Todo application built with Vanilla JavaScript featuring Local Storage persistence, drag-and-drop task organization, responsive themes and modern Web APIs to explore client-side application architecture.
...
intent:
  ...
  - Demonstrates client-side architecture
---
