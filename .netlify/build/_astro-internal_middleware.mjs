...
import { A as AstroError, R as ResponseSentError } from './chunks/astro/assets-service_CbyXuFXM.mjs';
import './chunks/astro/server_aSm7G1vp.mjs';
import { a as als, o as options, i as i18nextConfig, r as routes } from './chunks/internal_aCWP1Ea_.mjs';
...
const extractLocaleFromUrl = (pathname) => {
  for (const locale of options.locales) {
    {
      if (locale !== options.defaultLocale && pathname.startsWith(`/${locale}`)) {
        return locale;
      }
    }
  }
